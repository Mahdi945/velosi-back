...
import { OpportunitiesController } from '../../crm/controllers/opportunities.controller';
...
@Module({
  ...
  controllers: [OpportunityController, OpportunitiesController],
  providers: [OpportunityService, OpportunitiesService], // Service avec soft delete
  exports: [OpportunityService, OpportunitiesService],
})
